...
## Slide 19: Visualization Results

### UMAP Projection of Learned Embeddings

**Key Observations:**
1. **Clear Research Communities:** Database, AI, Systems researchers cluster separately
2. **Smooth Transitions:** Related fields (AI/ML) are adjacent
3. **Outlier Detection:** Noisy/miscategorized authors are visible
4. **Multi-disciplinary Authors:** Appear at cluster boundaries

**PCA Analysis:**
- First 3 components explain 35% of variance
- Much higher than random embeddings (~5%)
- Indicates meaningful structure capture

**Filtering Benefits:**
- Cleaner cluster separation
- Reduced noise in visualization
- Better-defined research boundaries

---

## Slide 20: Implementation Insights
...
- Joint node classification + link prediction
- Multi-graph embedding
- Transfer learning across domains

**4. Theoretical Analysis:**
- Tighter bounds on embedding quality
